		...
		case "http://www.opengis.net/ont/geosparql#ascLiteral":
			...
			for(String line:literalValue.split(System.lineSeparator())) {
					...
					if(nxcols!=null && result.getJSONObject("domain").getJSONObject("axes").getJSONObject("x").has("start")) 
						result.getJSONObject("domain").getJSONObject("axes").getJSONObject("x").put("stop", xllcorner+(cellsize*nxcols));
					if(nycols!=null && result.getJSONObject("domain").getJSONObject("axes").getJSONObject("y").has("start")) 
						result.getJSONObject("domain").getJSONObject("axes").getJSONObject("y").put("stop", yllcorner+(cellsize*nycols));
