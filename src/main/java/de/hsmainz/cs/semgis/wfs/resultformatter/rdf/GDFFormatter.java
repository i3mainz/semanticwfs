...
public class GDFFormatter extends ResultFormatter {

	public GDFFormatter() {
		this.urlformat="gdf";
		this.label="Graph Definition File (GDF)";
		this.mimeType="text/gdf";
		this.exposedType="text/gdf";
		this.fileextension="gdf";
		this.definition="https://www.cs.nmsu.edu/~joemsong/software/ChiNet/GDF.pdf";
	...
	public String formatter(ResultSet results, String startingElement, String featuretype, String propertytype,
        ...
        out.write("nodedef>name VARCHAR,label VARCHAR"+System.lineSeparator());
        ...
        out.write("edgedef>node1 VARCHAR,node2 VARCHAR,label VARCHAR"+System.lineSeparator());
