...
public class WebService {
	...
	public String describeFeatureType(@QueryParam("featuretype") String typename) throws XMLStreamException {
		String serviceType="WFS";
		XMLOutputFactory factory = XMLOutputFactory.newInstance();
		StringWriter strwriter=new StringWriter();
		XMLStreamWriter writer=factory.createXMLStreamWriter(strwriter);
	...
	@Produces(MediaType.TEXT_PLAIN)
	@Path("/getFeature")
	public String getFeature(@QueryParam("featuretype") String typename, @QueryParam("output") String output,@QueryParam("count") String count) throws JSONException, XMLStreamException {
