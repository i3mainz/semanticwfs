...
public class EWKTFormatter extends VectorResultFormatter {
	
	public EWKTFormatter() {
		this.mimeType="text/ewkt";
		this.exposedType="text/ewkt";
		this.urlformat="ewkt";
		this.label="Extended Well-Known-Text (EWKT)";
		this.fileextension="ewkt";
